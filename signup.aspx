...
<body class="registration-form">  
   ...
   <form novalidate method="post" action="signup.aspx">  
       <div class="field-group">  
           <h2 class="fieldstag">שם פרטי:</h2>  
           <input type="text" class="text-input" id="firstName" name="firstName">  
       ...
       <div class="field-group">  
           ...
           <input type="text" class="text-input" id="lastName" name="lastName">  
           <div class="error" id="lastNameError"></div>  
       </div>  

       <div class="field-group">  
           <h2 class="fieldstag">עיר:</h2>  
           <input type="text" class="text-input" id="city" name="city">  
       </div>  

       <div class="field-group">  
           <h2 class="fieldstag">תאריך לידה:</h2>  
           <input type="date" class="text-input" id="birthDate" name="birthDate">  
       ...
       <div class="field-group">  
           ...
           <div class="error" id="usernameExistsError" runat="server"></div>  
       </div>  
       ...
       <div class="field-group">  
           ...
           <input type="text" class="text-input" id="phone" name="phone">  
       ...
       <div class="field-group">  
           ...
           <input type="text" class="text-input" id="answer1" name="answer1">  
